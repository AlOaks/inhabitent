...
function red_starter_scripts() {
	...
	wp_enqueue_script('header-anim', get_template_directory_uri() .'/js/header-anim.js', array('jquery'), null, true);
	...
	wp_localize_script( 'header-anim', 'api_vars', array(
		'nonce' => wp_create_nonce( 'wp_rest' ),
		'success' => 'Thanks, your submission was received!',
		'failure' => 'Your submission could not be processed.',
		'greet' => 'Al Oaks is in da house!'
	  ) );

	  wp_localize_script( 'header-anim', 'red_vars', array(
